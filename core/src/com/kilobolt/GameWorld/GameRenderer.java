...
public class GameRenderer {
	...
	public void render(float runTime) {
		...
		if (myWorld.isReady()) {
			// Draw shadow first
			AssetLoader.shadow.draw(batcher, "EMPECEMOS :D", (136 / 2)
					- (42), 76);
			// Draw text
			AssetLoader.font.draw(batcher, "EMPECEMOS :D", (136 / 2)
					- (42 - 1), 75);
		} else {

			if (myWorld.isGameOver()) {
				AssetLoader.shadow.draw(batcher, "ESTUPIDO xD", 25, 56);
				AssetLoader.font.draw(batcher, "ESTUPIDO xD", 24, 55);

				AssetLoader.shadow.draw(batcher, "OTRA?", 23, 76);
				AssetLoader.font.draw(batcher, "OTRA?", 24, 75);
